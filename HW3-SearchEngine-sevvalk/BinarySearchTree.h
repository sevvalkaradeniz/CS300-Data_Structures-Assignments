...
class BinarySearchTree{
    ...
    BinaryNode<Comparable>* findNode(const Comparable&) ;
    BinaryNode<Comparable>*& findNode(const Comparable& x, BinaryNode<Comparable>* &t) ;
...
template <class Comparable>
BinaryNode<Comparable>* BinarySearchTree<Comparable>::findNode(const Comparable& x) {
    return find(x, root);
}
